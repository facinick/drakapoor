...
export default function Item({
  ...
  case 1: return (<div className={`relative transition-transform h-full-calc  p-4 overflow-hidden w-[360px] aspect-[4/1] col-span-1 row-span-1 flex items-center justify-center`}>
      <div className={`${interactionAnimation ? "active:scale-95" : ""} shadow-sm hover:outline outline-2 outline-button-dim transition-all border overflow-hidden rounded-3xl w-full h-full flex items-center justify-center`} >
       {children}
      </div>
